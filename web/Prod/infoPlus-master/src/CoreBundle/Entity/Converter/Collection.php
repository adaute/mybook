...
namespace CoreBundle\Entity\Converter;
...
use Sensio\Bundle\FrameworkExtraBundle\Request\ParamConverter\ParamConverterInterface as ParamConverterInterface;

class Collection implements ParamConverterInterface
{
    /**
    ...
    public function apply(Request $request, ParamConverter $configuration)
    {
        ...
        if($configuration->getOptions() == null) // permet de faire fonctioner les parameteconverter non personnalisé
            return;
